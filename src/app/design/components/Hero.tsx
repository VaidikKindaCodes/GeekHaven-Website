...
const Hero = () => {
  ...
  const getVideoSrc = (index: number) => `/design/videos/hero-${index}.mp4`;
    ...
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-64 font-robert-regular text-blue-100">
              Enter the Creative Layer <br /> Unleash the Imagination
            </p>
          </div>
        </div>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center gap-2 opacity-60">
          ...
          <RiScrollToBottomLine className="text-blue-50 text-2xl animate-bounce" />
        </div>
      </div>
